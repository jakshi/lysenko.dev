...
description = ""
draft = false
tags = ["learning", "go", "c", "ai"]
title = "Boot.dev Backend Path, Mostly for Fun"
+++

Finished the Backend Developer path on [boot.dev](https://www.boot.dev/) — mostly for fun, on weekends.
